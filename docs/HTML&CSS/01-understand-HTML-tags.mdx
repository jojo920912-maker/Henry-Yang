---
title: "HTML tag&semantic tag及Block element and inline element"
...
- **HTML tag（標籤）**：構成網頁的基本單位，告訴瀏覽器內容的用途
- **Semantic tag（語意化標籤）**：帶有明確意義的標籤，幫助瀏覽器與搜尋引擎理解內容結構
- **Block element vs Inline element**：兩種不同的排版行為，決定元素如何佔據空間
